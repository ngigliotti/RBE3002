...
def navToPose(goal):
    ...
    print "spin!" #turn to final angle
    rotate(0.5, desiredT)
...
def driveArc(radius, speed, angleArc):
    ...
    #Calculates how far the current angle is off by
    error = calcAngle-math.degrees(pose.orientation.z)

    #Drives in arc until the robot angle is clost to the correct angle
